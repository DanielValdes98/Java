		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(registro>0) {
						JOptionPane.showMessageDialog(null, "Registro actualizado","bien",JOptionPane.QUESTION_MESSAGE, null);
						textField.setText("");
						textField_1.setText("");
						textField_2.setText("");
						textField_3.setText("");
					} else {
						JOptionPane.showMessageDialog(null, "Error al actualizar registro","error",JOptionPane.ERROR_MESSAGE, null);
					}
				} catch (SQLException e2) {
					// TODO: handle exception
					e2.printStackTrace();
