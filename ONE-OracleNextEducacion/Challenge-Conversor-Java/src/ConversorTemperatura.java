...
public class ConversorTemperatura extends Conversor implements Convertir, ActionListener, ItemListener{
	...
	public ConversorTemperatura(String tipo) {
		super(tipo);
		setResizable(false);
				
		ArrayList<String> opcionesTemperaturas = new ArrayList<>();
		opcionesTemperaturas.add("Celcius a Farenheit");
		opcionesTemperaturas.add("Celcius a Kelvin");
		opcionesTemperaturas.add("Farenheit a Celcius");
		opcionesTemperaturas.add("Farenheit a Kelvin");
		opcionesTemperaturas.add("Kelvin a Celcius");
		opcionesTemperaturas.add("Kelvin a Farenheit");
		...
		JLabel lblNewLabel_1 = new JLabel("Ingrese la temperatura a convertir:");
		...
		JLabel lblNewLabel = new JLabel("Elije la opción a convertir: ");
		lblNewLabel.setBounds(10, 105, 300, 14);
		panel.add(lblNewLabel);
		
		comboBox = new JComboBox<Object>();
		comboBox.setBounds(10, 130, 185, 22);
		for(Object opcionTem : opcionesTemperaturas) {
			comboBox.addItem(opcionTem);
		}
		panel.add(comboBox);
