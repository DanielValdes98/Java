...
public class Conexion {
	...
	private static String url="jdbc:mysql://localhost:3306/prueba"; // JDBC: API | mysql: Gestor de BD
	
	static { // En este bloque static se cargar el driver una unica vez al correr el progrma
		try {
			/*
